...
import net.blking.rabbit.config.audit.AuditEventConverter;
import net.blking.rabbit.domain.PersistentAuditEvent;
...
import static net.blking.rabbit.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
