...
import net.blking.rabbit.config.Constants;
import net.blking.rabbit.domain.Authority;
import net.blking.rabbit.domain.User;
import net.blking.rabbit.repository.AuthorityRepository;
import net.blking.rabbit.repository.UserRepository;
import net.blking.rabbit.security.AuthoritiesConstants;
import net.blking.rabbit.service.MailService;
import net.blking.rabbit.service.UserService;
import net.blking.rabbit.service.dto.PasswordChangeDTO;
import net.blking.rabbit.service.dto.UserDTO;
import net.blking.rabbit.web.rest.errors.ExceptionTranslator;
import net.blking.rabbit.web.rest.vm.KeyAndPasswordVM;
import net.blking.rabbit.web.rest.vm.ManagedUserVM;
